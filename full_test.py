...
def main():
    pipe = get_T2V_pipeline(
        ...
        dit_path="/home/jovyan/dmitrienko/workspace/genai-team/kandinsky-5/kandinsky-5-0/saved_models/2B_r512ext_flash_8gpu_soft_rules/ema_model_10K/ema_shard_1gpu/model_small.safetensors",
        low_mem_usage=True,
    )
    seed = 42
    exp_name = 'small-offload'
